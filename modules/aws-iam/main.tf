#TERRAFORM SCRIPT FOR AWS IAM ROLE


#create a role for k8s-master servers
...
#create a role for k8s-worker server
...
#create a role-policy for k8s-master
...
#create a role-policy for k8s-node
